//
//  KitchenLeakViewController.swift
//  FirebaseTest
//
//  Created by Rohan MALIK on 12/17/17.
//  Copyright © 2017 RAJEEV MALIK. All rights reserved.
//

import UIKit

class KitchenLeakViewController: UIViewController {
	
	@IBOutlet weak var kitchenLeakTitle: UIView!
	
	@IBOutlet weak var kitchenImage: UIView!
	...
	@IBAction func yesButton(_ sender: UIButton) {
		HubViewController.foundLeaks.kitchenLeak = true
	}
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
		HubViewController.completions.kitchenPressed = true
		fadeInView(view: kitchenLeakTitle)
		DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
			self.fadeInView(view: self.kitchenImage)
			DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
